...
const AddSong = () => {
    ...
    const [image,setImage] = useState(false); //store song images
    ...
    const onSubmitHandler = async (e) => {
        ...
        e.preventDefault();  // it not reload the web page
        setLoading(true);
        try {
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
        <div className='flex gap-8'>
            <div className='flex flex-col gap-4'>
                <p>Upload song</p>
                <input onClick={(e)=>setSong(e.target.files[0])} type='file' id='song' accept='audio/*' hidden />
                ...
                <label htmlFor='song'>
                   ...
                   <div className='flex flex-col gap-4'>
                    ...
                    <p>Upload Image</p>
                    <input onClick={(e)=>setImage(e.target.files[0])} type='file' id='image' accept='image/*' hidden />
        ...
        <div className='flex flex-col gap-2.5'>
            ...
            <select onChange={(e) =>setAlbum(e.target.value)} defaultValue={album} className='bg-transparent outline-green-600 border-2 border-gray-400 p-2'>
